...
Hệ thống tiền đề GRACE đã giải quyết ảo giác ở cấp độ thực thể: mọi ứng viên đều truy xuất từ KG nên không có phim "tưởng tượng" nào lọt vào tập kết quả. Tuy nhiên, GRACE chưa có cơ chế đối chiếu từng ứng viên với các ràng buộc cứng mà người dùng đặt ra trong hội thoại — ví dụ danh sách phim đã xem cần loại trừ, ngưỡng điểm đánh giá tối thiểu, hay các thể loại tường minh bị từ chối. Với kiến trúc tĩnh không có vòng lặp phản hồi, nếu tập ứng viên hợp lệ sau lọc quá ít hoặc rỗng, pipeline dừng lại mà không có cơ chế khắc phục.
