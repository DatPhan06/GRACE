...
\begin{enumerate}
  \item \textbf{Cải thiện hiệu năng có kiểm chứng thống kê:} Trên tập mẫu đánh giá (20\%, $p < 0.01$), ARGOS vượt qua mô hình tiền đề GRACE trên toàn bộ các ngưỡng đo lường của cả hai bộ dữ liệu ReDial và INSPIRED, và đạt kết quả cạnh tranh so với các mô hình tinh chỉnh hàng đầu như DCRS — lưu ý rằng so sánh với SOTA chỉ mang tính định hướng do sự khác biệt về kích thước tập kiểm thử.
...
\begin{table}[H]
  ...
  \begin{tabular}{p{0.45\linewidth} p{0.45\linewidth}}
    ...
    \addlinespace
    Validator JSON schema đầu ra & Critic Agent — kiểm định ràng buộc cứng người dùng và tích hợp vòng lặp phản hồi \\
    \addlinespace
    Two-stage batching re-ranking & Relaxation Agent — tái cấu trúc ý định khi tập kết quả rỗng \\
    \addlinespace
