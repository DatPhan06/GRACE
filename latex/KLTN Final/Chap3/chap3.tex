...
\label{eq:similarity}
\end{equation}
trong đó $\lVert \mathbf{x} \rVert_2 = \sqrt{\sum_i x_i^2}$ là chuẩn Euclidean ($\ell_2$). Top-$m$ phim có $s_f$ cao nhất tạo thành tập kết quả $M_{\text{sem}}$. Luồng này đặc biệt hiệu quả khi nhu cầu người dùng mang tính sắc thái, chủ đề hoặc cảm xúc khó biểu diễn bằng từ khóa cứng (Hình \ref{fig:semantic_retrieval}).
