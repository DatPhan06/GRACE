...
Bài toán CRS được hình thức hóa như sau: cho tập item $\mathcal{I}$ và ngữ cảnh hội thoại tại lượt $t$, $C_t = \{u_1, s_1, \dots, u_t\}$, trong đó \mbox{$u_i$} là phát ngôn người dùng và \mbox{$s_i$} là phản hồi hệ thống ở lượt \mbox{$i$}, hệ thống thực hiện hai nhiệm vụ song song:
\begin{enumerate}
